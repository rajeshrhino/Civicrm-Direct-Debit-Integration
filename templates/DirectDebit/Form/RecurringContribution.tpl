...
<div class="view-content">
    <div id="help">
        You can setup a recurring payment. You need to setup a background process (cron job) which will create contributions on the specified intervals for the contact. Please note the 'Next Scheduled Date' is the date, the contribution will be created.  
    </div>
</div>
...
<table class="form-layout">
     <tr>
        ...
        {/if}    
				...
				<div class="description">{ts}This the date the contribution record will be created for the recurring payment. If you want to the first contribution on the start date, this should be same as start date.{/ts}</div>
        </td></tr>
